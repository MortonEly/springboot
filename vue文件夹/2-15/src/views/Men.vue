<template>
  <div>
    ...
    <div style="padding: 20px 0; display: flex; gap: 10px"
      ...
      <el-button id="role-button" type="primary" @click="handleAdd" >新增菜单<i class="el-icon-circle-plus-outline"></i>
      </el-button>
      <el-popconfirm
        class="ml-5"
...
export default {
  ...
  methods: {
    ...
    load() {
      ...
      //   });
      this.request.post("/menu/findAll").then(res => {
