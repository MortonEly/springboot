  ...
  <el-button type="warning" @click="reset" class="subjectbutton">重置</el-button>
    ...
    <div style="margin: 10px 0; display: flex; align-items: center;">
      ...
      <el-popconfirm
          ...
          @confirm="delBatch"
      >
        <el-button type="danger" slot="reference" class="filebutton">批量删除 <i class="el-icon-remove-outline"></i></el-button>
      </el-popconfirm>
    </div>
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="预览" >
        <template slot-scope="scope">
          <el-button type="primary" @click="preview(scope.row.url)" class="file_button">预览</el-button>
        </template>
      </el-table-column>
      <el-table-column label="下载" class="downbutton">
        <template slot-scope="scope">
          <el-button type="primary" @click="download(scope.row.url)" class="file_button">下载</el-button>
        </template>
      </el-table-column>
