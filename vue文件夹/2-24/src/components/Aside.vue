...
<el-menu
                ...
                :collapse="isCollapse"
>
<div style="color: #fff; text-align: center;line-height: 48px; font-size: 16px; font-weight: 400;">
  ...
  <el-submenu index="1">
    ...
    <el-menu-item-group>
      ...
      <el-menu-item index="/home">主页管理</el-menu-item>
    ...
    <el-menu-item-group title="分组2">
      ...
      <el-menu-item index="/noticle">公告管理</el-menu-item>
    </el-menu-item-group>
