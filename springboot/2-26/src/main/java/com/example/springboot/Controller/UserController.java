...
@RestController
@RequestMapping("/user")
@Api(value = "User控制类方法" ,tags = "User管理相关方法")
public class UserController {
         ...
         * @return
         */
        @ApiOperation(value = "根据id修改/新增保存User方法")
        @PostMapping("/save")
         ...
         * @return
         */
        @ApiOperation(value = "根据id删除用户方法接口")
         ...
         *  批量删除接口
         */
        @ApiOperation(value = "根据id批量删除用户接口")
...
//      搜索栏实现代码
         ...
         *
         */
        @ApiOperation(value = "根据username批量查询用户方法接口")
