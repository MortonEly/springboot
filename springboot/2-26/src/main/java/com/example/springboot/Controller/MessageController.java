...
public class MessageController {
        ...
        @PostMapping("/save")
        public Result save(@RequestBody Message message, HttpSession session) {
        ...
        public Result findAll(){
                ...
                return Result.success(200,"查询message中全部信息成功",messageService.list(queryWrapper));
        }
        ...
        public Result<List<Message>> getMessageTree() {
                // 调用 service 层方法获取构建好的评论树
                //List<Message> messages = getMessageDataFromDatabase(); // 从数据库获取留言数据
