package com.abocode.swagger2doc.utils;
...
public class JsonUtils {
    ...
    public static <T> T readValue(String jsonStr, Class<T> clazz) {
        try {
            ...
            throw  new JSONException("read json格式化异常",e);
        }
    }
    public static String writeJsonStr(Object obj)  {
        try {
        return objectMapper.writeValueAsString(obj);
        } catch (IOException e) {
            throw  new JSONException("write json格式化异常",e);
        }
    }
